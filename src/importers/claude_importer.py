...
class ClaudeImporter(BaseImporter):
    ...
    def _parse_markdown_conversation(self, content: str, file_path: Optional[Path] = None) -> Dict[str, Any]:
    ...
    def _extract_topics(self, content: str) -> List[str]:
        ...
        claude_topics = [
            "claude", "anthropic", "ai assistant", "conversation",
            "natural language", "reasoning", "analysis", "creative writing"
        ]
