...
class TestChatGPTSchema:
    ...
    def test_schema_author_roles(self):
        ...
        message_obj = [obj for obj in node_schema["properties"]["message"]["oneOf"] if obj.get("type") == "object"][0]
                ...
                "mapping": {
                    ...
                    "msg-2": {
                        ...
                        "message": {
                            ...
                            "content": {"content_type": "text", "parts": ["Hello! How can I help you?"]}
                        },
                        "parent": "msg-1",
                        "children": []
                    }
            ...
            "mapping": {
                ...
                "msg-2": {
                    "message": {
                        "author": {"role": "assistant"},
                        "create_time": 1705312860.0,
                        "content": {"content_type": "text", "parts": ["I can help with Python programming!"]}
                    }
                }
            }
        }
        ...
        conversation = {
            ...
            "mapping": {
                ...
                "msg-2": {
                    "message": {
                        "author": {"role": "assistant"},
                        "content": {"content_type": "text", "parts": ["Hi there!", "How are you?"]}  # 9 + 12 = 21 chars
                    }
                }
            }
        }
        ...
        conversation = {
            ...
            "mapping": {
                "msg-1": {
                    "message": {
                        "author": {"role": "user"},
                        "content": {"content_type": "text", "parts": ["valid string", 123, None, {"object": "data"}]}
                    }
                }
            }
        }
...
class TestMainModule:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='[{"title": "Test", "create_time": 1705312800.0, "conversation_id": "test-123", "mapping": {}}]')
